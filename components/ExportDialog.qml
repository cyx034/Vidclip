            ...
            ColumnLayout {
                ...
                GroupBox {
                    ...
                    GridLayout {
                        ...
                        MComboBox {
                            ...
                            currentIndex: 0
                            onCurrentTextChanged: exportFormat = currentText.toLowerCase()
                        }
                        ...
                        RowLayout {
                            ...
                            MComboBox {
                                ...
                                onCurrentTextChanged: {
                                    resolution = currentText + "x" + resolutionHeight.currentText
                                }
                            }
                            ...
                            MComboBox {
                                ...
                                currentIndex: 3
                                onCurrentTextChanged: {
                                    resolution = resolutionWidth.currentText + "x" + currentText
                                }
                            }
                        }
                        ...
                        MComboBox {
                            ...
                            currentIndex: 0
                            onCurrentTextChanged: encoder = currentText
                        }
                        ...
                        RowLayout {
                            ...
                            MComboBox {
                                ...
                                currentIndex: 2
                                onCurrentTextChanged: frameRate = parseFloat(currentText)
                            }
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: "Size：about " + Math.round(bitrate * 12 / 8 / 1024) + " MB"
                            color: Style.textcolor
                            font.pixelSize: 12
                        }
                    }
